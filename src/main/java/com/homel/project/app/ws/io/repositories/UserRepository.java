...
public interface UserRepository extends PagingAndSortingRepository<UserEntity, Long> {
    ...
    @Query("select user.firstName from UserEntity user where user.userId =:userId")
    List<Object[]> findUserFirstNameByUserId(@Param("userId") String userId);

    @Transactional
    @Modifying
    @Query("update UserEntity u set u.emailVerificationStatus = :emailVerificationStatus WHERE u.userId = :userId")
    void updateUserEmailVerificationStatusByUserId(
